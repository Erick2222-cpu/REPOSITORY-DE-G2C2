...
public class MainguiController {
    ...
    class MenuItemListener{
        Map<String, String[]> menus=Map.of(
                 "menuItem1", new String[]{"/view/main-cliente.fxml", "Reg. Cliente","T"},
                "menuItem2", new String[]{"/view/main-cliente.fxml", "Reg. Cliente","T"},
                "menuItem3", new String[]{"/view/main-cliente.fxml", "Salir","C"}
        );
